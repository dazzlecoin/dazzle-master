...
const string strMessageMagic = "dazzle Signed Message:\n";
...
// dazzle: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dazzle", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Dazzle Coin";
        CTransaction txNew;
        txNew.nTime = 1506929209;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3fbffa8f85c48d0414a66b49a6e7cfc63b1cd8e0be238d76e3382fc6f4da9d3e"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb4, 0xf1, 0xc1, 0xd6 };
